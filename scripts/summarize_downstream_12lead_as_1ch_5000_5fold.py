...
TASK = "task1b-12lead-as-1ch-5000-to-our-wrist1ch"
...
def main():
    parser = argparse.ArgumentParser(description="Summarize 12lead-as-1ch pretrain to our wrist 5-fold downstream.")
    parser.add_argument("--result_root", default="ml-famae/model_ckpt/downstream-5000-12lead-as-1ch-to-our-wrist-5fold")
    parser.add_argument("--n_folds", type=int, default=5)
    args = parser.parse_args()

    root = Path(args.result_root)
    print("=" * 128)
    print("12-LEAD-AS-1CH PRETRAIN -> OUR WRIST 1CH, 5000-SAMPLE INTRA-SUBJECT 5-FOLD")
