...
def main():
    parser = argparse.ArgumentParser(description="Check wrist-2lead-as-1ch pretraining data and BioFAME token shape.")
    parser.add_argument("--data_dir", default="./data_wecg_wrist_2lead_as_1ch_5000")
    parser.add_argument("--data_name", default="wECGdb_wrist_2lead_as_1ch")
    ...
    print("OK: channel-independent wrist-2lead data is [N*2, 1, L], encoder tokens are [B, 250, 64].")
