...
RESULT_ROOT="${RESULT_ROOT:-./model_ckpt/downstream-5000-12lead-as-1ch-to-our-wrist-5fold}"
FOLD_ROOT="${FOLD_ROOT:-./data_our_wrist_hrv_5000_5fold}"
CHECKPOINT="${CHECKPOINT:-./model_ckpt/wecg-12lead-as-1ch-5000-pretrain-300ep-bs64_bioFAME/ckpt.pt}"
TASK_NAME="task1b-12lead-as-1ch-5000-to-our-wrist1ch"
